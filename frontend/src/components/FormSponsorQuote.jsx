...
const FormSponsorQuote = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.submitSponsorQuote(formData);
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <option value="clinops">Clinical Operations Manager</option>
          <option value="pm">Project Manager (CRO / Sponsor)</option>
          <option value="procurement">Outsourcing / Procurement</option>
          <option value="director">Medical Director / Director</option>
...
export default FormSponsorQuote;
